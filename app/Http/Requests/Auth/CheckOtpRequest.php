...
class CheckOtpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'type' => [
                'required',
                Rule::in([Otp::TYPE_EMAIL]),
            ],
            'email' => [
                Rule::when(($this['type'] === Otp::TYPE_EMAIL), 'required', 'nullable'),
                'email',
                Rule::exists('otps', 'data'),
            ],
