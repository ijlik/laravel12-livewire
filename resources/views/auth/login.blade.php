                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <input type="text" name="email" class="form-control" id="signin-email" placeholder="Enter Email" value="">
                                </div>
                                <div class="col-xl-12 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <p>Kirim Otp Melalui</p>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="email" checked name="otp_type"> Email
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="whatsapp" name="otp_type"> Whatsapp
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        <div class="form-check">
