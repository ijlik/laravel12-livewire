                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-6 col-sm-8 col-12">
                    <div class="card custom-card border-0 shadow-none my-4">
                        <div class="card-body p-5">
                            <div>
                                <h4 class="mb-1 fw-semibold">Masukan Kode OTP</h4>
                                <p class="mb-4 text-muted fw-normal">Please check email to find otp</p>
                            </div>
                            <form method="POST" action="{{ route('login.otp') }}">
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        <label for="signin-email" class="form-label text-default">Kode OTP</label>
                                        <input type="text" id="otp" name="otp" class="form-control" placeholder="Enter OTP" value="" autofocus>
                                    </div>
